...
O DNS (Domain Name System) é um protocolo TCP/IP, que age como se fosse uma lista telefonica traduzindo o 
nome(dominio), para o numero(IP). Todo o computador e roteador tem um servidor DNS que vai se atualizando a medida em que o
usuario vai acessando diferentes dominios. Mas se ele não encontrar, há servidores DNS que podem ser consultados, 
os provedores de internet geralmente tem seu servido, bem como google e OpenDNS também tem seus proprios 
servidores recursivos. 

O Dig nos permite  consultar manualmente os servidores DNS recursivos de nossa escolha para obter informações sobre dominios.
É uma ferramenta muito util para soluções de problemas de rede.